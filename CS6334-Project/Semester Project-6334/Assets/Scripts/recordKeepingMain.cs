...
{
    // player script that has player infomration stored
    ...
    void Start()
    {
      // setting button names to show the correct exercise
      text_field1.text = player.exercise1.exercise_name;
      text_field2.text = player.exercise2.exercise_name;
      text_field3.text = player.exercise3.exercise_name;
    }
    ...
    public void button_exercise1(){
      ...
      current_pos=0;
      current_exercise = player.exercise1;
      date_found = false;
    ...
    public void button_exercise2(){
      ...
      // setting global variables for navigation keys on panel2
      current_pos=0;
      current_exercise = player.exercise2;
      date_found = false;
    ...
    public void button_exercise3(){
      ...
      // setting global variables for navigation keys on panel2
      current_pos=0;
      current_exercise = player.exercise3;
      date_found = false;
